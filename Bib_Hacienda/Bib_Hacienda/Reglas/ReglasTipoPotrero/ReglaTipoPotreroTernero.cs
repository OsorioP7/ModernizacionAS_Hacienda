...
{
    public class ReglaTipoPotreroTernero : IReglasTipoPotrero
    {
        private readonly IReglaEdadRes regla_edad;
        private readonly IReglaPesoRes regla_peso;

        public string TipoPotrero => "ternero";

        public ReglaTipoPotreroTernero(IReglaEdadRes regla_edad, IReglaPesoRes regla_peso)
        {
        ...
        public Res CrearRes(string nombre, uint peso, ushort edad) =>
            new Ternero(nombre, peso, edad, regla_edad, regla_peso);
    }
}
