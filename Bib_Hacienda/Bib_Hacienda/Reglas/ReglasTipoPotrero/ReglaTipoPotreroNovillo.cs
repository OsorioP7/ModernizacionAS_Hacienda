...
{
    public class ReglaTipoPotreroNovillo : IReglasTipoPotrero
    {
        private readonly IReglaEdadRes regla_edad;
        private readonly IReglaPesoRes regla_peso;

        public string TipoPotrero => "novillo";

        public ReglaTipoPotreroNovillo(IReglaEdadRes regla_edad, IReglaPesoRes regla_peso)
        {
        ...
        public Res CrearRes(string nombre, uint peso, ushort edad) =>
            new Novillo(nombre, peso, edad, regla_edad, regla_peso);
    }
}
