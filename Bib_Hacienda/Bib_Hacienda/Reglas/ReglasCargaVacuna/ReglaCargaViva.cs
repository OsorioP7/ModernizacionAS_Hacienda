...
{
    public class ReglaCargaViva : IReglaCargaTipoVacuna
    {
        public string TipoVacuna => "Viva";
        ...
        public Vacuna Cargar(string[] partes)
        {
            if (partes.Length >= 8)
            {
                ...
                return new Viva(nombreVacuna, loteAplicado, fechaVencAplicada, fechaAplicAplicada, enum_l_atenuaciones.Atenuacion10);
            }
            ...
            return new Viva(nombre, lote, fechaVenc, fechaAplic, enum_l_atenuaciones.Atenuacion10);
        }
